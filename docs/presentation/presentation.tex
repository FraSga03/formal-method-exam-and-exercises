...
\begin{center}\includegraphics[width=0.66\textwidth]{waiting_times.png}\end{center}
\small
...
\begin{itemize}
  ...
  \item The analysis reflects what was \emph{recorded}. Poor recording discipline looks
        like rework.
\end{itemize}
\end{frame}
